...
- **Matchs interactifs (vos choix comptent)** — **causerie d'avant-match** (rassurer / hausser le ton / neutre) qui modifie le moral, puis match en **deux mi-temps** avec un **écran de pause** : ajustez mentalité, tempo et pressing, et faites jusqu'à **3 remplacements**. La 2e période est simulée avec vos réglages ; le pressing haut **fatigue** l'équipe, les entrants sont **frais**.
