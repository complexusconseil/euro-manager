...
const EN = {
  ...
  "Cliquez sur un nom pour la fiche du joueur. « Prêter » envoie un joueur en prêt une saison ; les prêts entrants portent le badge « prêt ».":"Click a name for the player profile. \"Loan out\" sends a player away for the season; incoming loans carry the “loan” badge.",
  ...
  "Exercice clos dans le rouge":"Financial year closed in the red",
  "Dette trop lourde : les dirigeants placent":"Debt too heavy: the board lists",
  "sur la liste des transferts.":"on the transfer list.",
  "Dette trop lourde : les dirigeants s'alarment.":"Debt too heavy: the board is alarmed.",
  "journée":"matchday",
  "exempt (qualifié d'office)":"bye (through automatically)",
  "de la phase de ligue":"of the league phase",
  "facultatif · sélection :":"optional · national team:",
  "Budget insuffisant :":"Insufficient budget:",
  "M€ demandé,":"M€ requested,",
  "M€ dispo.":"M€ available.",
  "ne souhaite pas se séparer de":"does not wish to part with",
  "un cadre de l'effectif.":"a key member of the squad.",
  "ne prête pas":"will not loan out",
  "élément trop important":"too important a player",
  "Budget insuffisant pour l'indemnité de prêt":"Insufficient budget for the loan fee",
  "en prêt.":"on loan.",
  "est prêté à":"is loaned to",
  "La saison n'a pas pu être clôturée. Exportez votre sauvegarde avant de poursuivre.":"The season could not be closed. Export your save before continuing.",
  "Il part une saison entière et ne pourra pas être rappelé avant plusieurs journées.":"He leaves for a whole season and cannot be recalled for several matchdays.",
  "fichier illisible, piste retirée.":"unreadable file, track removed.",
  ...
  "poste vacant":"vacant slot",
  "Face à":"Facing", "l'adversaire":"the opposition", "milieu":"midfield",
  "défense":"defence", "moral moyen":"average morale", "Sélection":"National team",
  "force":"strength",
  "BUT":"GOAL", "se blesse":"is injured", "est expulsé":"is sent off",
  "avertissement":"booking", "Fin du match":"Full time", "remplacer par":"replace with",
  "Force du onze":"Line-up strength",
  "J":"P", "G":"W", "N":"D", "P":"L", "BP":"GF", "BC":"GA", "Diff":"GD", "Pts":"Pts",
  "Saison":"Season", "Champion":"Champion", "(vous)":"(you)", "Supercoupe":"Super Cup",
  "ne peut pas revenir : votre effectif est au complet (30).":"cannot return: your squad is full (30).",
  "est un élément trop important pour partir en prêt.":"is too important a player to go out on loan.",
  "en":"in",
